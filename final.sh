...
# Function to add users to sudo group based on a user list file
add_users_to_sudo_group() {
...
echo "5) Add users to sudo group from file"
read -p "Enter your choice (1/2/3/4/5): " action
